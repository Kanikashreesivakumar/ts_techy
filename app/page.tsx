...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-900 via-blue-950 to-slate-800 text-white overflow-x-hidden relative">
      {/* Enhanced background particles with dynamic white integration */}
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-amber-400/40 rounded-full animate-ping animation-delay-1000"></div>
        <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-white/60 rounded-full animate-pulse animation-delay-3000"></div>
        <div className="absolute bottom-1/3 left-1/3 w-3 h-3 border border-amber-400/30 rounded-full animate-spin-slow"></div>
      </div>
