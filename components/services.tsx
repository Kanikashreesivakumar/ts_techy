...
const services = [
  ...
  },
  {
    ...
    features: ["Meta Tag Optimization", "Content Structure", "Technical SEO", "Schema Markup"],
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl sm:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Transform your digital presence with our data-driven SEO strategies designed to deliver{" "}
            <span className="text-amber-400 font-semibold">measurable results</span> and sustainable growth for your
            business.
          </p>
        </div>
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Enhanced card with advanced 3D effects */}
                <div className="relative h-full bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 transition-all duration-700 group-hover:scale-105 group-hover:bg-white/10 hover:rotate-1 hover:shadow-2xl hover:shadow-amber-500/20 overflow-hidden will-change-transform">
                  {/* Service Image with enhanced overlay and effects */}
                  <div className="relative overflow-hidden rounded-t-3xl h-64">
                    ...
                    <div className="absolute inset-0 z-30">
                      {/* Main service icon with enhanced 3D effect */}
                      <div
                        className={`absolute top-6 right-6 w-16 h-16 bg-gradient-to-r ${service.gradient} rounded-xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-2xl`}
                        style={{
                  ...
                  <div
                    className={`absolute bottom-0 left-0 h-1 bg-gradient-to-r ${service.gradient} transition-all duration-700 ${isHovered ? "w-full" : "w-0"}`}
                  ></div>
